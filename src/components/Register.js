          ...
          <Form style={{width: "300px"}} onSubmit={handleRegister} ref={form}>
            {!successful && (
              <div>
                ...
                <div>
                  <br/>
                  <small style={{color: "white"}}>*If you are under the age of 13 please do not singup for our service without parental consent*</small>
                  <small style={{color: "white"}}>By creating an account with us, you are agreeing to our <a href="/legal#Termsofservice">Terms of service</a></small><br/>
