       ...
       <div id="Page" className="App">
            ...
            <div id="Content">         
                <body className="App-body">
                      ...
                      <div style={{backgroundImage: "https://images5.alphacoders.com/849/thumb-1920-849437.jpg"}} class="list-shop"><h4>GTAV Recoverys</h4> <p>Stock: Varies</p><p>Price: $5 - $30</p> <a href="#"><button style={{color: "white", background: "#000", border: "2px #fff solid", borderRadius: "5px"}}>Options</button></a></div>
