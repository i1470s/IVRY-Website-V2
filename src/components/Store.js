       ...
       <div id="Page" className="App">
            ...
            <div id="Content">         
                <body className="App-body">
                      ...
                      <div class="list-shop3"><h4>Discord Nitro</h4> <p>Stock: 0</p><p>Price: $5.50</p> <button style={{color: "white", background: "#000", border: "2px #fff solid", borderRadius: "5px"}} data-sellix-product="5f643a59f027a" type="submit">Purchase</button></div> 
                      <div class="list-shop3"><h4>Custom Discord Bot</h4> <p>Price: $25</p> <button style={{color: "white", background: "#000", border: "2px #fff solid", borderRadius: "5px"}} data-sellix-product="6083c9146e422" type="submit">Purchase</button></div>  
                      <div class="list-shop3"><h4>Hire Us</h4> <p>Price: Varies</p> <a href="https://linktr.ee/brayden_viana"><button style={{color: "white", background: "#000", border: "2px #fff solid", borderRadius: "5px"}}>Contact</button></a></div>
                      <div class="list-shop3"><h4>Donations</h4> <p>Price: Varies</p> <a href="https://www.paypal.com/donate?hosted_button_id=QWT56W6DFV8H4"><button style={{color: "white", background: "#000", border: "2px #fff solid", borderRadius: "5px"}}>Donate</button></a></div>
