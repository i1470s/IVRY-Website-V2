...
const Profile = () => {
  ...
  return (
    <div id="Page" className="App">
      ...
      <a style={{color: "white"}} href="http://api-ivry.tk"><button style={{color: "white", background: "#fb5804", border: "2px #fb5804 solid", borderRadius: "25px", width: "100px", minWidth: "100px", fontSize: "20px"}}>API</button></a>
      <br/>
      <br/>
      <br/>
      <br/>
