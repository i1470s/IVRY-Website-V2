...
const Profile = () => {
  ...
  return (
    <div id="Page" className="App">
      ...
      <a style={{color: "white"}} href=""><button style={{border: "2px #fff solid", background: "#000", borderRadius: "5px"}}>Delete Account</button></a><br/><br/>
      <a style={{color: "white"}} href=""><button style={{border: "2px #fff solid", background: "#000", borderRadius: "5px"}}>Version Information</button></a>
