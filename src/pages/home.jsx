      ...
      <div id="Page" className="App">
        ...
        <div id="Nav-bar" className="nav">
          <header className="App-header">
                <a href="https://ivry.tk/"><b style={{float: "left", fontSize: "30px", color: "#fb5804"}}>⠀IVRY</b></a> <a style={{float: "right", margin: "10px"}} href="/user"><img width="30px" height="30px" alt="search" src={user}/></a>
          </header>
        </div>
        ...
        <div id="Footer">
          <footer className="App-footer">
                <a href="/home"><img style={{opacity: ".25"}} width="30px" height="40px" alt="home" src={home}/></a>⠀⠀⠀⠀⠀⠀
